...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-1">
                <asp:HyperLink runat="server" ID="hlCityAddEdit" Text="Add City" ToolTip="City -- Add" NavigateUrl="~/AdminPanel/City/CityAddEdit.aspx" CssClass="btn btn-success btn-sm"></asp:HyperLink>
            </div>
        </div>
                ...
                <asp:GridView ID="gvCity" runat="server" AutoGenerateColumns="false" OnRowCommand="gvCity_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="btnEdit" Text="Edit" CssClass="btn btn-info btn-sm" CommandName="EditRecord" NavigateUrl='<%#"~/AdminPanel/City/CityAddEdit.aspx?CityID=" +Eval("CityID").ToString().Trim() %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
